...
# $ run -p 8080:8080 joke-service
# should be available at http://localhost:8080/api/joke
#
# Push to dockerhub
# $ docker login
# $ docker tag jokeservice jaktau/joke-service
# $ docker push jaktau/joke-service
#
# Retrieve the image from docker hub
# $ docker pull jaktau/joke-service